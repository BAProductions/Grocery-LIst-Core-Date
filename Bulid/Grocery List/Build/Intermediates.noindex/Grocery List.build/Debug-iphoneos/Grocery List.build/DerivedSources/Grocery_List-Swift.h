...
SWIFT_MODULE_NAMESPACE_PUSH("Grocery_List")
@class UIWindow;
@class UIApplication;
...
@interface MasterViewController : UITableViewController <NSFetchedResultsControllerDelegate, MFMailComposeViewControllerDelegate, UISearchBarDelegate, UISearchDisplayDelegate>
...
- (void)markMulitpleRowsAsChecks:(id _Nonnull)sender;
